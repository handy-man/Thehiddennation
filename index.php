      ...
      <div class="site-wrapper-inner">
		...
		?>
          ...
          <div class="inner cover">
            ...
            <p class="lead">Welcome to Nathan Hand's personal website, lots of different directories on this website lead to my personal projects.</p>
            <p class="lead">
              <a href="./projects.php" class="btn btn-lg btn-default">My projects</a>
            </p>
          </div>
